...
# 2.2.5.2: Fixed issues in psd1 that prevented corect import of the module.
@{
    ...
    CmdletsToExport   = 'Get-DotNetVersion'
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Fixed issues in psd1 that prevented corect import of the module.'
